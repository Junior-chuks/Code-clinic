...
def captured_io(stdin):
    ...
    try:
        ...
        sys.stdout, sys.stderr, sys.stdin = old_out, old_err, old_input@contextmanager
def captured_output():
    ...
    try:
        ...
        sys.stdout, sys.stderr = old_out, old_errdef run_unittests(test_filename):
    """
    ...
    suite = loader.loadTestsFromName(test_filename)    runner = unittest.TextTestRunner(stream=sys.stdout)
